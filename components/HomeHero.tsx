      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between py-3 gap-x-4">
          ...
          <div className="flex items-baseline gap-2 flex-shrink-0">
            <span className="text-[var(--phosphor-green)] phosphor-glow text-3xl sm:text-4xl tracking-wide power-on">
              RETROSPORTTV
              <span className="text-[var(--phosphor-amber)] amber-glow">.GE</span>
            </span>
            <span className="text-[#222] text-xs tracking-widest hidden sm:inline">v1.0</span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4 text-xs tracking-widest">
            <span className="text-[#333]">
              PKG <span className="text-[#555] ml-1">SPORTS CLASSICS</span>
            </span>
            <span className="text-[#1e1e1e]">|</span>
            <span className="text-[#333]">
              CH <span className="text-[#555] ml-1">{String(channelCount).padStart(2, "0")}</span>
            </span>
            <span className="text-[#1e1e1e]">|</span>
            <span className="text-[var(--phosphor-amber)] opacity-75 tracking-widest">◄ ON AIR ►</span>
          </div>
        ...
        <div className="border-t border-[#111] py-1">
          <p className="text-[#2e2e2e] text-xs tracking-[0.3em]">
